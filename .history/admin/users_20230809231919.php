    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        <div class="content">
            ...
            <form class="form-inline form" action="" method="POST">
                ...
                <input type="text" class="form-control" name="cpassword" placeholder="confilm password ">
                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input name="text" placeholder="email" type="email" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="cpassword" placeholder="confilm password " type="password" class="form-control"
                                id="exampleInputPassword1">
                        </div>
